...
const app = express();
const PORT = 3000; // Your frontend app.js should point to this port
...
// In a real app, these would be your actual database tables/collections.
let mockUsers = {}; // Stores user data for demo (balance, username, etc.)
let mockWithdrawals = []; // Stores withdrawal requests for demo
